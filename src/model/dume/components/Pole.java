...
public class Pole extends Composite {
    ...
    public static final Pitching A3 = new Pitching(Math.PI / 2.0);
    public static final Collinear Q3 = new Collinear(5.5 * DumE.MULTIPLIER, 3.0 * DumE.MULTIPLIER, 7.0 * DumE.MULTIPLIER);
