...
public class DraftFirstPhalanx {
    ...
    public static void buildPatella(BranchGroup branchGroup, final float radius) {
        ...
        pin.setAppearance(ElementVirtualization.buildAppearance(Color.GRAY));
    ...
    public static void buildBloc(BranchGroup branchGroup, final float radius, final float length) {
        ...
        com.sun.j3d.utils.geometry.Box box = new com.sun.j3d.utils.geometry.Box(radius, length / 2.0f, radius / 1.5f, ElementVirtualization.buildAppearance(Color.DARK_GRAY));
